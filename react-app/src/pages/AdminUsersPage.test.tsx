...
const admin: User = { id: 'admin-1', username: 'admin', role: 'admin', streamQuota: 0, canUseCompositor: false, avatar: null, createdAt: '2026-01-01', lastLoginAt: null }
const viewer: User = { id: 'viewer-1', username: 'viewer-1', role: 'viewer', streamQuota: 0, canUseCompositor: false, avatar: null, createdAt: '2026-01-01', lastLoginAt: null }
  ...
  it('creates a user and refreshes the list', async () => {
    ...
    const fetchMock = vi.fn((url: string, init?: RequestInit) => {
      ...
      if (url === '/api/admin/users' && init?.method === 'POST') {
        const created: User = { id: 'new-1', username: 'newperson', role: 'viewer', streamQuota: 0, canUseCompositor: false, avatar: null, createdAt: '2026-01-01', lastLoginAt: null }
        users = [...users, created]
