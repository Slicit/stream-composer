  ...
  it('creates a user and refreshes the list', async () => {
    ...
    const fetchMock = vi.fn((url: string, init?: RequestInit) => {
      ...
      if (url === '/api/admin/users' && init?.method === 'POST') {
        const created: User = { id: 'new-1', username: 'newperson', role: 'viewer', email: null, emailConfirmed: false, otpEnabled: false, streamQuota: 0, compositorQuota: 0, avatar: null, createdAt: '2026-01-01', lastLoginAt: null }
        users = [...users, created]
